class MeasurementConstants {
  ...
  static const int defaultScanDurationSec = 3;
  static const int longScanDurationSec = 5;

  static const double normalRadiusPx = 40.0;
  static const double normalPpgVariance = 8.0;
}
